 ...
 */
let previousBest: Int  = 14392
let newBest: Int = 15125

print("Congradulations, " + fullName + "! You beat your previous daily high score of " + previousBest + " steps by walking " + newBest + " steps yesterday!")
